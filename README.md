...
Periodically checks for processes that are in D state (uninterruptable sleep, basically "waiting on IO"), straces them if they keep doing that, and stops stracing once they don't.
