...
- Stops stracing and gives a summary when they stop being in D state, the process stops running, or you press Ctrl-C on this program. 
...
I consider this a feature because it ends up ignores some (series of) shorter-but-not-instant syscalls (like smartd's), but you may wish to lower it.
